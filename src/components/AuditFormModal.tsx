...
const AuditFormModal = ({ isOpen, onClose, triggerSource }: AuditFormModalProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Step B: Data Sync (Direct submission without AI pre-generation to avoid auth prompts)
            const payload = {
                name: formData.name,
                email: formData.email,
                company: formData.company,
                description: formData.description,
                analysis: "Analysis to be generated by OMA team." // Placeholder since we removed client-side AI
            };
            ...
            // Even if fetch fails (it shouldn't with no-cors), we might want to show success to user or a friendly error
